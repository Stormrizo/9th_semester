...
Donde $B$ es el \textbf{magnetic induction}.

Tenemos:


\[ \vec{B} = - \frac{ \vec{v}\times \vec{F_{B}}  }{v^{2}q} + K_{1}\vec{V}_{1}  \]

Entre las muchas direcciones que pueda tener una partícula.

Tenemos:



Demostrar si tenemos una torca asociada al circuito, 


Observando las áreas a los circuitos conectados. Capítulo numero 2 del curso y capítulos 5 y 6.
