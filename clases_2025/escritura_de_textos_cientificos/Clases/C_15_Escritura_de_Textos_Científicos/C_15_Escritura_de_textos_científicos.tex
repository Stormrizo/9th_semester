...
\title{ \textcolor{Tarawera}{\textbf{Clase \# 4}}: \textcolor{Cinnabar}{\textbf{¿Qué es una cita bibliográfica?}}}
...
\section{Clase \#15} \vspace{0.5cm}

\begin{enumerate}
\item Reconocer al autor por su trabajo y darle el crédito de sus ideas\\
\item Evitar el plagio\\
\item Identificar las publicaciones de las que fue tomado el tema o idea referida en el texto.\\
\item Buscar las fuentes de información citadas en el trabajo\\
\item Otorgar credibilidad al trabajo\\
\item Unir un trabajo actual con uno anterior
\end{enumerate}
 
 
 Lo que debe citarse:
 
Ideas, opiniones, teorías de otras personas, datos estadísticos, gráficos, imágenes que sean de conocimiento público, cualquier referencia a las palabras de otra persona, parafraseo de las palabras de otra persona.
 
 
 \subsection{Tipos de citas}
 
 \textbf{citas textuales}
 
 Se transcribe tal cual aparece en la obra, se pone entre comillas o en cursivas y se agrega entre \textbf{paréntesis}, \textbf{autor}, \textbf{año de edición y página}.
 
 \textbf{Cita de citas}
 
 Comezar a hacer nuestra propia base de datos, leer los resumenes, y luego la parte importante.
 
 Lo que se hace en \textbf{citas no textuales}
 
 Consiste en un resumen breve parafraseando de una parte de la obra o de toda ella. Existen dos tipos:
 
 \textbf{Cita no textual específica:} Se refiere a una parte de la obra, se escribe sin comillase incluye la o las páginas de donde se ha resumido.
 
 \textbf{Cita no textual general}: Resume el contenido total de un escrito, va sin comillas y no se agrega el número de páginas.
 
  
\subsection{¿Qué son las referencias bibliográficas?}

Es el conjunto de datos o elementos que describen de forma detallada el documento del que se ha obtenido información (libros, revistas, artículos, bases de datos, sitios web, entrevistas, etc.) permitiendo su identificación.

Estas indican la información que se ha de incluir, así como el orden que debe presentarse al citar cuando se elabora un texto u hacer una bibliografía.

Se recomienda usar, \textbf{APA}, \textbf{Chicago}, \textbf{Harvard}, \textbf{IEEE}, entre otras.

Las fuentes primarias son las fuentes que ya fueron revisadas por alguien.

APA es muy orientado a sociales, tambipen orientado a biología.

Se usa mucho en ciencias exactas e ingenierías, es el IEEE.


Los datos esenciales que identifican un documento son: \textbf{Autor}, \textbf{título}, \textbf{fecha}, \textbf{editorial}, \textbf{lugar}, \textbf{DOI/URL}, \textbf{páginas}, \textbf{formato}.

El conjunto de estos conforman la \textbf{Referencia Bibliográfica}, y el conjunto de referencias conforman la \textbf{bibliografía}.

Existen varias formas de presentar las referencias:

\begin{itemize}
\item[$\bullet$] Por nombre y año
\item[$\bullet$] 
\item[$\bullet$]
\end{itemize}

\subsection{Uso y abuso de la información}

\underline{Está permitido}

\begin{itemize}
\item[$\bullet$] Hacer una copia privada de uso exclusivamente para estudiar mejor\\
\item[$\bullet$] Reseñar, comentar, criticar, resumir, parafrasear o aludir a información ajena, de 
\end{itemize}
 
 \textbf{Checar foto en teléfono}
