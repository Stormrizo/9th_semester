...
\title{ \textcolor{Tarawera}{\textbf{T-\textcolor{Sun}{\textbf{1}}}}: \textcolor{Apple Green}{\textbf{Alegoría de la caverna}}}
...
\begin{multicols}{2} % Comienza las dos columnas
	...
	\begin{enumerate}[label={{\textcolor{trueblue}{\textbf{Ej}. \arabic*.0}}}, start=1]
		\item Realizar un \textcolor{Cinnabar}{\textbf{resumen}} y \textcolor{trueblue}{\textbf{opinión personal}} del mito de la \textcolor{Apple Green}{\textbf{alegoria de caverna}} de Platón del libro 7$^{\circ}$ de la república.
	\end{enumerate}
\end{multicols} 
...
\section*{Mito de la alegoría de la caverna (\textcolor{Cinnabar}{\textbf{Resumen}})}
\addcontentsline{toc}{section}{Mito de la alegoría de la caverna (\textcolor{Cinnabar}{\textbf{Resumen}})}

En esta alegoría, Platón nos presenta a \textbf{unos prisioneros que han estado encadenados dentro de una caverna desde que nacieron}. Ellos se encuentran \underline{de espaldas a la entrada}, sin poder girar la cabeza ni ver el mundo exterior. Detrás de ellos hay una \textbf{fogata}, y entre el fuego y la entrada de la cueva pasan personas y objetos.

Las \underline{\textbf{sombras}} de esas personas y cosas se proyectan sobre la pared que los prisioneros observan todo el tiempo. Para ellos, esas sombras son \textbf{la única realidad que conocen}. Creen firmemente que esas figuras son seres reales, ya que jamás han visto otra cosa distinta. Incluso los sonidos que escuchan los asocian con las sombras que ven, reforzando aún más su idea de realidad.

Un día, uno de los prisioneros es \textbf{liberado} y llevado fuera de la caverna por primera vez. Al principio, la \underline{luz del fuego y luego la del Sol} le lastiman los ojos, se siente confundido y desorientado. No logra distinguir bien los objetos del nuevo entorno y cree que lo que ve afuera no es real. Cuando le explican que las cosas del exterior son las verdaderas y que las sombras solo eran \textbf{reflejos}, se queda perplejo, pues durante toda su vida creyó que las sombras eran la verdad.

Poco a poco, sus ojos se van adaptando. Primero puede observar los \underline{reflejos en el agua}, después los objetos directamente, y finalmente logra mirar al \textbf{Sol}, comprendiendo que su luz es la \underline{fuente de todo} lo que antes veía en forma de sombras. En ese momento, entiende que ha vivido engañado.

El prisionero \textbf{regresa a la cueva} para contar lo que ha descubierto a sus compañeros que siguen presos. Sin embargo, al volver a la oscuridad, ya no logra ver con claridad las sombras en la pared. Los otros prisioneros, al notar su dificultad para ver, creen que el viaje al exterior \underline{lo ha vuelto débil y confundido}. Se burlan de él, no le creen y se resisten completamente a cualquier intento de ser liberados, pues temen abandonar lo único que conocen.

De esta manera, Platón nos muestra cómo muchas veces las personas se aferra a lo que creen, incluso cuando estas están basadas en apariencias, y rechazan aquello que podría llevarlas a un conocimiento más profundo de la realidad.

\subsection*{\textcolor{trueblue}{\textbf{Opinión personal}}}
\addcontentsline{toc}{subsection}{\textcolor{trueblue}{\textbf{Opinión personal}}}

En mi opinión, la alegoría de la caverna sigue siendo \textbf{muy actual}, porque describe bastante bien cómo muchas personas vivimos conformándonos con lo que vemos y oímos, sin cuestionar si esto es realmente la \textbf{verdad}. Muchas veces preferimos las \underline{sombras cómodas} a enfrentarnos a una realidad que exige pensar, dudar y cambiar nuestras ideas. Salir de la caverna no es fácil, y Platón deja claro que el conocimiento casi siempre puede ser doloroso, pero un día un rayo de luz puede que nos haga liberarnos de nuestras verdades más básicas, es decir tomar decisiones dificile. 
