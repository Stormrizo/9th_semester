...
\title{Clase \#29 - Enseñanza de la Física}
...
Durante la sesión de hoy se realizó una actividad en parejas que consistió en identificar tres ideas principales del \textbf{primer subcapítulo} y tres del \textbf{segundo subcapítulo}, ambos pertenecientes al \textbf{Capítulo II} del texto trabajado en clase.

\medskip

Se discutieron los conceptos de \textbf{implícito} y \textbf{explícito} como dimensiones fundamentales del comportamiento y la expresión humana.  
Lo \textbf{implícito} se entiende como aquello que \emph{gobierna y condiciona} nuestras manifestaciones externas, es decir, lo que guía lo que hacemos explícito.  
Por su parte, lo \textbf{explícito} corresponde a aquello que emerge y se manifiesta de manera visible o consciente, muchas veces determinado por lo que recibimos desde el vientre materno y por las experiencias tempranas que configuran nuestra forma de actuar.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{1.png}
    \caption{Relación entre lo implícito y lo explícito en la formación de las actitudes.}
    \label{fig:mi_figura}
\end{figure}

Asimismo, se reflexionó sobre cómo las \textbf{actitudes} representan la parte \emph{explícita} de nuestra conducta, mientras que las estructuras profundas que las determinan pertenecen al plano \emph{implícito}.  

\medskip

\textbf{Tarea:} Para el día miércoles, se deberá completar la lectura y análisis de los dos capítulos restantes del texto y subirlos a la plataforma.
