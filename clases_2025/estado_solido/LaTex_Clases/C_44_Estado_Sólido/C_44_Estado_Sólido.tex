...
\section{Análisis de difracción de rayos X en las muestras del DITCO}


Análisis de difractometro,


Coincidan en posicición e intensidad.

\textbf{DIFRACC.EVA V4.0}

Puede ser 


Seria viable hacer un análisis químico del café.

Necesitamo \textbf{composición química en principio}.

Crystallographic organic.

Análisis químico. 

Documento, importar

Bouckground, 0 threshold.

Toda la caracterización, o solo la ficha asociada a la cafeína.
...
Las fichas, deben de estar debajo. 

backgound subtracted.
